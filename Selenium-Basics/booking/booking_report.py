...
class BookingReport:
    ...
    def __init__(self, boxes_section_element:WebElement): # :type for autocompletion
    ...
    def pull_deal_box_attributes(self):
        ...
        for deal_box in self.deal_boxes:
            hotel_name = deal_box.find_element(By.CSS_SELECTOR, '[data-testid="title"]'
                                   ).get_attribute('innerHTML').strip()

            hotel_price = deal_box.find_element(By.CSS_SELECTOR, '[data-testid="price-and-discounted-price"]'
                                                ).get_attribute("textContent")

            hotel_score = deal_box.find_element(By.CSS_SELECTOR, 'div[data-testid="review-score"] > div'
